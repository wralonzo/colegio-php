...
class Login
{
	...
	public function insertar($nombre, $telefono, $email, $login, $clave, $imagen, $permisos, $rol)
	{
		$sql = "INSERT INTO usuario (nombre,telefono,email,login,clave,imagen,rol)VALUES (?, ?, ?, ?, ?, ?, ?);";
		$params = array($nombre, $telefono, $email,  $login, $clave, $imagen, $rol);
